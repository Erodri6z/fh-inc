      ...
      <ul  className={`nav-menu ${isDropdownOpen ? 'open' : ''}`}>
        <li>
          <button className='nav-btn' onClick={toggleDropdown}>
            <Link className='nav-item' onClick={toggleDropdown} to="landing" smooth={true} duration={500}>
          ...
          <li>
            <button className='nav-btn' onClick={toggleDropdown}>
            <Link className='nav-item' onClick={toggleDropdown} to="about" smooth={true} duration={500}>
          ...
          <li>
            ...
            <Link className='nav-item' onClick={toggleDropdown} to="service" smooth={true} duration={500}>
          ...
          <li>
            <button className='nav-btn' onClick={toggleDropdown}>
            <Link className='nav-item' onClick={toggleDropdown} to="projects" smooth={true} duration={500}>
          ...
          <li>
            <button className='nav-btn' >
              <Link className='nav-item' onClick={toggleDropdown} to='contact' smooth={true} duration={500}>
